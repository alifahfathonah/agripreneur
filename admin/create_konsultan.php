...
<!-- AWAL SLIDE BUAT -->
        ...
        if(isset($_POST["submit"])){
            ...
            if ($konsultan->create()){
              ...
              echo "
                  <script>
                  document.location.href = 'create_konsultan.php';
                  </script>
              ";
            }   
        }
        ...
        <table class='table table-hover table-responsive table-bordered'>
            ...
            <tr>
                <td>nama</td>
                <td style="width:100%;"><input type='text' name='nama' class='form-control' /></td>
            </tr>
            ...
            <tr>
                ...
                <!-- categories from database will be here -->
                                 <select class="form-control" id="kategori" name="kategori">
                                    ...
                                    <option value="Keuangan dan Pajak">Keuangan dan Pajak</option>
                                    <option value="Legalitas dan Perizinan">Legalitas dan Perizinan</option>
...
<div class="tabcontent"  id="Lihat">
   ...
   // page given in URL parameter, default page is one
        ...
        $page_url = "create_konsultan.php?";
         
        // count all products in the database to calculate total pages
        $total_rows = $konsultan->countAll();
           
     include_once "readtabel_konsultan.php" 
...
<script type="text/javascript" src="js/delete_konsultan.js"></script>
