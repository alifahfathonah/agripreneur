            ...
            <li>
                ...
                <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Layanan Kami
                    ...
                    <ul class="dropdown-menu layanan">
                        ...
                        <li><a href="indexProduk.php"> <i class='fas fa-chalkboard-teacher'></i>Jasa konsultasi</a></li>
...
<?php 
$queryProgram = "SELECT * FROM program WHERE id_program = ".$_GET["idprogram"]." ";
$hslProgram = mysqli_query($koneksi,$queryProgram);
$rcrdProgram = mysqli_fetch_assoc($hslProgram);
?>
    <div class="row bg-gray">
        <div class="col-md-11 mainbarss">
            <h5 style="font-size:20px;"><?= $rcrdProgram["judul_program"]?></h5>
            <h3 style="font-size:14px;" ><?= $rcrdProgram["kategori_program"]?></h3>
            <div class="row">
                <div class="col-md-8 deskripsi" style=""> <!-- ini bagian isi program -->
                    <img src="../admin/images/<?= $rcrdProgram["foto"]?>"> <!--ambil dari db-->
                    <p><?= $rcrdProgram["isi_program"]?></p>
                </div>
                <div class="col-md-3 green-border singkat">
                    <div class="masing">
                        <label><i class='far fa-money-bill-alt mr-5' style='color:#57b846; margin-right:5px;'></i>Biaya</label>
                        <p><?= $rcrdProgram["harga_program"]?></p>    
                    </div>
                    <div class="masing">
                        <label><i class='fas fa-book-open mr-5' style='color:#57b846; margin-right:5px;'></i>Kategori</label>
                        <p><?= $rcrdProgram["kategori_program"]?></p>    
                    </div>
                    <div class="masing">
                        <label><i class='far fa-clock mr-5' style='color:#57b846; margin-right:5px;'></i>Waktu Penyelenggaraan</label>
                        <p><?= $rcrdProgram["waktu_penyelanggaraan"]?></p>    
                    </div>
                </div>
            </div>
        </div>
