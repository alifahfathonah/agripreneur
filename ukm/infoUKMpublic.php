    ...
    <div class="row mb-3">
        ...
        <div class="tabcontent" id="komoditas">
            <div class="containerr ">
                ...
                <div class="grid-container ">
                    <?php 
                    $querySelectKomoditas = "SELECT id_kmdt,gambar_kmdt,judul_kmdt FROM komoditas INNER JOIN `kmdt-prod`  as tabel1 ON tabel1.id_komoditas = komoditas.id_kmdt
                    ...
                    ?>
                    <div class="card">
                      <img class="infoKomoditas" src="img/<?= $rcrdSelectKomoditas['gambar_kmdt']?>" alt="Avatar" style="width:100%;" data-toggle="modal" data-target="#formModalKomoditas" data-id="<?= $rcrdSelectKomoditas["id_kmdt"] ?>" data-nama="<?= $_GET["data"] ?>">
                      <div class="container-card">
  ...
  <div class="modal fade" id="formModalProduk" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="row">
            <div class="col-md-6">
                <img class="imgproduk" id="gambarProduk">
            </div>
            <div class="col-md-5 green-border pd-5" style="margin-left:5px;">
                <div class="row ">
                    <div class="col-md-2">
...
<div class="modal fade" id="modalArtikel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <input type="text" name="id_artikel" id="id_artikel" style="display:none;">
                    ...
                    <h5 style="font-size:20px;" id="judul_artikel"></h5>
                    <h3 style="font-size:14px;" id="kategori_artikel"></h3>
                    <img src="" id="gambar_artikel" class="rounded mx-auto d-block"  style="width:100%;max-width:300px">
                    <p id="deskripsi_artikel"></p>
                    <p id="isi_artikel"></p><br>
                    Sumber :
                    <p id="sumber_artikel"></p>
        ...
        $('.infoProduk').on('click', function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#deskProduk').text(data.deskripsi_produk);
                    $('#id_produk').val(data.id_produk);
                    $('#pemilik_produk').val(data.pemilik_produk);
                    $('#gambarProduk').attr('src','img/'+data.gambar);
        ...
        $('.infoArtikel').on('click', function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#kategori_artikel').text(data.kategori_artikel);
                    $('#judul_artikel').text(data.judul_artikel);
                    $('#deskripsi_artikel').text(data.desk_artikel);
                    $('#isi_artikel').text(data.isi_artikel);
                    $('#sumber_artikel').text(data.sumber_artikel);
