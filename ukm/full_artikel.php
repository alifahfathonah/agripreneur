...
<?php 
$queryArtikel = "SELECT * FROM artikel WHERE id_artikel = ".$_GET["idArtikel"]." ";
$hslArtikel = mysqli_query($koneksi,$queryArtikel);
$rcrdArtikel = mysqli_fetch_assoc($hslArtikel);
?>
    <div class="row bg-gray">
        <div class="col-md-11 mainbarss">
            <h5 style="font-size:20px;"><?= $rcrdArtikel["judul_artikel"]?></h5>
            <h3 style="font-size:14px;" ><?= $rcrdArtikel["kategori_artikel"]?></h3>
            <div class="row">
                <div class="col-md-8 deskripsi" style=""> <!-- ini bagian isi Artikel -->
                    <img src="img/<?= $rcrdArtikel["image"]?>"> <!--ambil dari db-->
                    <p><?= $rcrdArtikel["isi_artikel"]?></p>
                </div>
                <div class="col-md-3 green-border singkat">
                    <div class="masing">
                        <label><i class='far fa-money-bill-alt mr-5' style='color:#57b846; margin-right:5px;'></i>Sumber</label>
                        <p><?= $rcrdArtikel["sumber_artikel"]?></p>    
                    </div>
                    <div class="masing">
                        <label><i class='fas fa-book-open mr-5' style='color:#57b846; margin-right:5px;'></i>Kategori</label>
                        <p><?= $rcrdArtikel["kategori_artikel"]?></p>    
                    </div>
                    <div class="masing">
                        <label><i class='far fa-clock mr-5' style='color:#57b846; margin-right:5px;'></i>Penerbit</label>
                        <p><?php 
                        if($rcrdArtikel["user_staff"] == NULL ){
                            echo $rcrdArtikel["user_ukm"];
                        }else
                            echo $rcrdArtikel["user_staff"];
                        ?></p>    
                    </div>
                </div>
            </div>
