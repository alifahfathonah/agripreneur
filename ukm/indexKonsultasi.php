...
function selectByKategori($field){
    include "koneksi.php";
    $query = "SELECT * FROM konsultan WHERE kategori_konsultan = '".$field."'";
            ...
            <li>
                ...
                <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Layanan Kami
                    ...
                    <ul class="dropdown-menu layanan">
                        <li class="program_result"><a href="program_result.php">  <i class="  fas fa-dollar-sign"></i>Program dan Pendanaan</a></li>
                        <li class=""><a href="indexArtikel.php"> <i class="  fas fa-file-alt"></i>Artikel dan Berita</a></li>
                        <li class="active"><a href="indexKonsultasi.php"> <i class='fas fa-chalkboard-teacher'></i>Jasa konsultasi</a></li>
    ...
    <div class="row bg-gray">
        ...
        <div id="main-menu" class="list-group">
                ...
                <div class="collapse list-group-level1" id="sub-menu">
                    <a href="indexKonsultasi.php" class="list-group-item <?php 
                        if(isset($_GET["kategoriKonsultasi"])){
                    ...
                    <a href="indexKonsultasi.php?kategoriKonsultasi=Branding%2FPemasaran" class="list-group-item 
                                    <?php 
                        if(isset($_GET["kategoriKonsultasi"])){
                            if($_GET["kategoriKonsultasi"]=="Branding/Pemasaran"){
                                echo "active";
                            }
                        }
                        ?>" data-parent="#sub-menu">Branding/Pemasaran</a>
                    <a href="indexKonsultasi.php?kategoriKonsultasi=Keuangan%20dan%20Pajak" class="list-group-item <?php 
                        if(isset($_GET["kategoriKonsultasi"])){
                            if($_GET["kategoriKonsultasi"]=="Keuangan dan Pajak"){
                                echo "active";
                            }
                        }
                        ?>" data-parent="#sub-menu">Keuangan dan Pajak</a>
                     <a href="indexKonsultasi.php?kategoriKonsultasi=Legalitas%20dan%20Perizinan" class="list-group-item <?php 
                        if(isset($_GET["kategoriKonsultasi"])){
                            if($_GET["kategoriKonsultasi"]=="Legalitas dan Perizinan"){
                                echo "active";
                            }
                        }
                        ?>" data-parent="#sub-menu">Legalitas dan Perizinan</a>
                    <a href="indexKonsultasi.php?kategoriKonsultasi=Rencana%20Bisnis" class="list-group-item <?php 
                        if(isset($_GET["kategoriKonsultasi"])){
                            if($_GET["kategoriKonsultasi"]=="Rencana Bisnis"){
                                echo "active";
                            }
                        }
                        ?>" data-parent="#sub-menu">Rencana Bisnis</a>
        ...
        <div class="col-md-9 mainbarss">
                            ...
                            <div class="head-search" style="margin-bottom:10px;">
                                <form role="form">
                                    <!-- Input Group -->
                                    <div class="input-group" >
                                        <input type="text" style="border-radius:3px;" class="form-control" placeholder="Cari Konsultasi">
                                            <span class="input-group-btn">
                                              <button type="submit" class="btn btn-hijau">
             ...
             <?php 
             if(isset($_GET["kategoriKonsultasi"])){
                $hslQuery = selectByKategori($_GET["kategoriKonsultasi"]);
                ...
                while($rcrd = mysqli_fetch_assoc($hslQuery)){
                    ?>
                    <div class="card">
                      <img class="infoProduk" src="../admin/images/<?= $rcrd["foto"]?>" style="width:100%">
                      <div class="container-card p5 m5">
                        <h6><b></b></h6> 
                        <div class="row">
                            <div class="col-md-12">
                            <p><b><?= $rcrd["kategori_konsultan"]?></b></p>
                            <p><?= $rcrd["nama_konsultan"]?></p>
                            </div>
                        </div>
                      </div>
                        <div class="absolom" style="width:100%; padding:10px;"  >
                            <a  href="full_konsul.php?idKonsultasi=<?= $rcrd["id_konsultan"]?>" class='btn btn-hijau' style="padding:3px; " >
