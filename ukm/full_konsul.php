                    ...
                    <li>
                        <div class="m-menu-content">
                            <ul class="col-md-6">
                                ...
                                <li><a href="indexProduk.php?kategori=Makanan">Makanan</a></li>
                                <li><a href="indexProduk.php?kategori=Minuman">Minuman</a></li>
                                <li><a href="indexProduk.php?kategori=Camilan">Camilan</a></li>
                            </ul>
                            <ul class="col-md-6">
                                <li class="dropdown-header">Alat</li>           
                                <li><a href="indexProduk.php?kategori=Kriya">Kriya</a></li>
                                <li><a href="indexProduk.php?kategori=Teknologi">Teknologi</a></li>
                                <li><a href="indexProduk.php?kategori=Bahan%20Mentah">Bahan Mentah</a></li>
                            </ul>
                        </div>
                    </li>
                    </ul>
...
<section class="centered" style="margin-left:10%">
<?php 
$queryKonsultan = "SELECT * FROM konsultan WHERE id_konsultan = ".$_GET["idKonsultasi"]." ";
$hslKonsultan = mysqli_query($koneksi,$queryKonsultan);
$rcrdKonsultan = mysqli_fetch_assoc($hslKonsultan);
?>
    <div class="row bg-gray">
        <div class="col-md-11 mainbarss">
            <h5 style="font-size:20px;"><?= $rcrdKonsultan["nama_konsultan"]?></h5>
            <h3 style="font-size:14px;" ><?= $rcrdKonsultan["kategori_konsultan"]?></h3>
            <div class="row">
                <div class="col-md-8 deskripsi" style=""> <!-- ini bagian isi Konsultan -->
                    <img src="../admin/images/<?= $rcrdKonsultan["foto"]?>" > <!--ambil dari db-->
                    <p><?= $rcrdKonsultan["isi_konsultan"]?></p>
                </div>
                <div class="col-md-3 green-border singkat">
                    <div class="masing">
                        <label><i class='far fa-money-bill-alt mr-5' style='color:#57b846; margin-right:5px;'></i>Harga</label>
                        <p><?= $rcrdKonsultan["harga_konsultan"]?></p>    
                    </div>
                    <div class="masing">
                        <label><i class='fas fa-book-open mr-5' style='color:#57b846; margin-right:5px;'></i>Kategori</label>
                        <p><?= $rcrdKonsultan["kategori_konsultan"]?></p>    
                    </div>
                    <div class="masing">
                        <label><i class='far fa-clock mr-5' style='color:#57b846; margin-right:5px;'></i>Penerbit</label>
                        <p><?php 
                            echo $rcrdKonsultan["user_staff"];
                        ?></p>    
                    </div>
                </div>
            </div>
