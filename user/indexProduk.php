    ...
    <div class="row bg-gray">
        ...
        <div id="main-menu" class="list-group">
                ...
                <div class="collapse list-group-level1" id="sub-menu">
                    <a href="indexProduk.php" class="list-group-item <?php 
                    ...
                    <a href="indexProduk.php?kategoriProduk=Makanan" class="list-group-item 
                                    <?php 
                        if(isset($_GET["kategoriProduk"])){
                    ...
                    <a href="indexProduk.php?kategoriProduk=Minuman" class="list-group-item <?php 
                        if(isset($_GET["kategoriProduk"])){
                     ...
                     <a href="indexProduk.php?kategoriProduk=Camilan" class="list-group-item <?php 
                        if(isset($_GET["kategoriProduk"])){
                    ...
                    <a href="indexProduk.php?kategoriProduk=Kriya" class="list-group-item <?php 
                        if(isset($_GET["kategoriProduk"])){
                    ...
                    <a href="indexProduk.php?kategoriProduk=Teknologi" class="list-group-item <?php 
                        if(isset($_GET["kategoriProduk"])){
                    ...
                    <a href="indexProduk.php?kategoriProduk=Bahan%20Mentah" class="list-group-item <?php 
                        if(isset($_GET["kategoriProduk"])){
        ...
        <div class="col-md-9 mainbarss">
             ...
             if(isset($_GET["kategoriProduk"])){
                ...
                while($rcrd = mysqli_fetch_assoc($hslQuery)){
                    ?>
                    <div class="card">
                      <img class="infoProduk" src="../ukm/img/<?= $rcrd["gambar"]?>" style="width:100%">
