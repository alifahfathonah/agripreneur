...
<?php 
$queryProduk = "SELECT * FROM produk WHERE id_produk = ".$_GET["idProduk"]." ";
$hslProduk = mysqli_query($koneksi,$queryProduk);
$rcrdProduk = mysqli_fetch_assoc($hslProduk);
?>
    <div class="row bg-gray">
        <div class="col-md-11 mainbarss">
            <h5 style="font-size:20px;"><?= $rcrdProduk["nama_produk"]?></h5>
            <h3 style="font-size:14px;" ><?= $rcrdProduk["kategori_produk"]?></h3>
            <div class="row">
                <div class="col-md-8 deskripsi" style=""> <!-- ini bagian isi Produk -->
                    <img src="img/<?= $rcrdProduk["gambar"]?>"> <!--ambil dari db-->
                    <p><?= $rcrdProduk["deskripsi_produk"]?></p>
                </div>
                <div class="col-md-3 green-border singkat">
                    <div class="masing">
                        ...
                        <p><?= $rcrdProduk["kategori_produk"]?></p>    
                    </div>
                    <div class="masing">
                        <label><i class='far fa-clock mr-5' style='color:#57b846; margin-right:5px;'></i>Pemilik Produk</label>
                        <a href="infoUKMpublic.php?data=<?= $rcrdProduk["pemilik_produk"]?>" ><p><?= $rcrdProduk["pemilik_produk"]?></p></a>    
                    </div>
                </div>
            </div>
        </div>
